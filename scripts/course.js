const courses = [
    ...
    { code: "WDD 231", name: "Web Frontend Development", credits: 3, category: "WDD", completed: false }, // Note: WDD 231 is 3 credits in this course curriculum structure
    { code: "CSE 110", name: "Programming Building Blocks", credits: 2, category: "CSE", completed: true },
...
function displayCourses(courseList) {
    ...
    // FIX: Updates the inner value of the span cleanly
    creditsContainer.textContent = totalCredits;
}

displayCourses(courses);

/* BUTTONS & FILTERS ACTIVE TOGGLES */
